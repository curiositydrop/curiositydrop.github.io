...
if(location.pathname.endsWith('/bands.html')||location.pathname.endsWith('/musicians.html')||location.pathname.endsWith('/venues.html'))import('./legacy-profile-claim-links.js?v=2').catch(error=>console.error('Error loading legacy profile claim links:',error));
